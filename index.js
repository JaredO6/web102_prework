...
let displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${numUnfundedGames} game${numUnfundedGames > 1 ? "s remain" : "remains"} unfunded. We need your help to fund these amazing games!`;
...
let firstGameElement = document.createElement("h2");
firstGameElement.textContent = firstGame.name;
firstGameContainer.appendChild(firstGameElement);

// do the same for the runner up item
let secondGameElement = document.createElement("h2");
secondGameElement.textContent = secondGame.name;
secondGameContainer.appendChild(secondGameElement);

//OPTIONAL: Adds search bar and button to find games by name
